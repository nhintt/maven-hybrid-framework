...
public class Level_16_Pattern_Object extends BaseTest {
	...
	public void User_01_Register() {
		...
		userRegisterPage.inputToTextboxByID(driver, "FirstName", "John");

		log.info("User_01_Register - Step 04: Input to Lastname textbox");
		userRegisterPage.inputToTextboxByID(driver, "LastName", "Terry");
		...
		userRegisterPage.openHeaderPageByName(driver, "Log out");
		userHomePage = PageGeneratorManager.getUserHomePage(driver);
